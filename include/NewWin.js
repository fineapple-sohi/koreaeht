...
// 주석: 해피스크립트.넷  시마 (javascript@xpert.co.kr)
// site: happyscript.net
// 010712 사용의 편의을 위해 간단하게 주석을 달았습니다.
// 파일이 너무커서 주석을 단부분에 항상 ***를 넣었습니다, 서치기능을 이용하시면 쉽게 이동할 수 있습니다.
...
'	windowBORDERCOLORsel	= "#ccddff"                                                                                                                                             '+ '\n'+
'	windowTITBGCOLOR    	= "#ccddff"                                                                                                                                             '+ '\n'+
...
function openIT() {
                //지정된 주소의 페이지가 뜹니다.
	theURL="http://www.koreaeht.com/catalog/index.html"
	wname ="CHROMELESSWIN"
                //창의 크기를 지정하는 곳입니다.
	W=500;
	H=800;
                //타이틀바에 나오는 닫기버튼 이미지입니다.
	windowCERRARa 		= "img/close_a.gif"
	windowCERRARd 		= "img/close_d.gif"
	windowCERRARo 		= "img/close_o.gif"
	windowNONEgrf 		= "img/none.gif"
	windowCLOCK		= "img/clock.gif"
	windowREALtit		= "+++ Electric Heat Trace Leader_KOREA EHT(koreaeht.com) +++"
                //창틀없는 창의 타이틀바에 나오는 내용입니다.
	windowTIT 	    	= "<font face=verdana size=1 color=E0E0C0> +++ Electric Heat Trace Leader_KOREA EHT(koreaeht.com) +++</font>"
                //경계선의 색을 지정합니다.
	windowBORDERCOLOR   	= "#ccddff"
	windowBORDERCOLORsel	= "ABA614"
                //타이틀바의 색을 지정합니다.
	windowTITBGCOLOR    	= "#ccddff"
	windowTITBGCOLORsel 	= "ABA614"

                //실제로 창틀없는 창을 여는 함수를 부릅니다. 이걸 아무데서나 직접 불러도 됩니다.
