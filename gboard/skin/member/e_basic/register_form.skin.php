	...
	<tr>
		<td align="center" style="padding:10px 10px 0px 10px;">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<select name=mb_password_q_select onchange="this.form.mb_password_q.value=this.value;">
						...
						<table width="350" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class=m_padding2><input class=m_text type=text name="mb_password_q" size=55 required itemname="비밀번호 분실시 질문" value="<?=$member[mb_password_q]?>"></td>
							</tr>
						</table>
					</TD>
				</tr>
				...
				<tr>
					<TD class=m_title>닉네임(별명)</TD>
					<TD class='m_padding lh'>
					<input class=m_text type=text name='mb_nick' maxlength=20 minlength="2" required hangulalphanumeric itemname="닉네임(별명)" value='<?=$member[mb_nick]?>' onchange="fregisterform.mb_nick_enabled.value='';">
		...
		<script language="JavaScript">//document.getElementById('mb_sex').value='<?=$member[mb_sex]?>';</script>
				...
				<tr>
					<TD class=m_title>자택전화</TD>
					<TD class=m_padding><input class=m_text type=text name='mb_tel' size=20 maxlength=20 <?=$config[cf_req_tel]?'required':'';?> itemname='자택전화' value='<?=$member[mb_tel]?>'></TD>
				</tr>
				<? } ?>
				...
				<tr>
					...
					<td class=m_padding><input class=m_text type=text name='wr_key' required itemname='자동등록방지' size=20>&nbsp;&nbsp;* 왼쪽의 글자중 <FONT COLOR="red">빨간글자</font>만 순서대로 입력하세요.</td>
				</tr>
				<? } ?>
				<tr><td colspan="2" height="5"></td></tr>
				<tr>	
