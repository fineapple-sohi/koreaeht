...
<tr> 
    ...
    <td width="5" align="center" valign="middle" bgcolor="#7BB2D6"><img src="<?=$board_skin_path?>/img/list_top_02.gif" width="5" height="33"></td>
    <td width="5" align="center" valign="middle" bgcolor="#EEEEEE"><img src="<?=$board_skin_path?>/img/list_top_03.gif" width="5" height="33"></td>
    ...
    <td width="40" align="center" valign="middle" bgcolor="#EEEEEE"><?=subject_sort_link('wr_datetime', $qstr2, 1)?><font class=w_title><strong>날짜</strong></font></a></td>
    <td width="40" align="center" valign="middle" bgcolor="#EEEEEE"><font class=w_title><strong>조회</strong></font></td>
    <? if ($is_good) { ?><td width="40" align="center" valign="middle" bgcolor="#EEEEEE"><font style="font-family:돋움; font-size:9pt; color:#7993AF"><strong>추천</strong></font></td><? } ?>
    <? if ($is_nogood) { ?><td width="40" align="center" valign="middle" bgcolor="#EEEEEE"><font style="font-family:돋움; font-size:9pt; color:#A07C7C"><strong>비추천</strong></font></td><? } ?>
...
<tr <? if ($list[$i][is_notice]) { ?>bgcolor="#F9FBFB"<? } ?>> 
    ...
    <td width="40" align="center" valign="middle">
        ...
        ?></td>
    <td width="5" align="center" valign="middle"><img src="<?=$board_skin_path?>/img/trans5.gif" width="5" height="33"></td>
    <td width="5" align="center" valign="middle"><img src="<?=$board_skin_path?>/img/trans5.gif" width="5" height="33"></td>
    <? if ($is_category) { ?><td width="70" align="center" valign="middle"><font class=w_font><strong><a href="<?=$list[$i][ca_name_href]?>"><?=$list[$i][ca_name]?></a></strong></font></td><? } ?>
