...
<tr>
    ...
    <td><input class='field' maxlength=20 size=15 name=wr_name itemname="NAME" required value="<?=$name?>"></td></tr>
...
<tr>
    ...
    <td><input class='field' type=password maxlength=20 size=15 name=wr_password itemname="PASSWORD" <?=$password_required?>></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>
...
<tr>
    ...
    <td><input class='field' maxlength=100 size=50 name=wr_email email itemname="E-MAIL" value="<?=$email?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>
...
<tr>
    ...
    <td><input class='field' size=50 name=wr_homepage itemname="HOMEPAGE" value="<?=$homepage?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>
...
if ($is_notice || $is_html || $is_secret || $is_mail) { 
    ...
    if ($is_mail) {
        $option .= "<input type=checkbox value='mail' name='mail' $recv_email_checked>TO MAIL&nbsp;";
    }
}
...
<tr>
    ...
    <td><select name=ca_name required itemname="CATEGORY"><option value="">CHOICE<?=$category_option?></select></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<? } ?>

<tr>
    <td class=write_head>TITLE</td>
    <td><input class="field" style="width:100%;" name=wr_subject id="wr_subject" itemname="TITLE" required value="<?=$subject?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
    ...
    <td style='padding:5 0 5 0;'>
        ...
        <? } ?>
        <textarea id="wr_content" name="wr_content" class=tx style='width:100%; word-break:break-all;' rows=15 itemname="CONTENT" required 
