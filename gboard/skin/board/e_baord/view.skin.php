...
<div style="clear:both; height:30px;">
    ...
    <span style="color:#888888;font-size:11px;">DATE : <?=date("y-m-d H:i", strtotime($view[wr_datetime]))?></span>
    </div>
...
<div style="border:1px solid #ddd; clear:both; height:34px; background:url(<?=$board_skin_path?>/img/title_bg.gif) repeat-x;">
    ...
    <tr>
        <td style="padding:8px 0 8 10px;">
            <div style="color:#505050; font-size:11px; font-weight:bold; word-break:break-all;">
...
<tr>
    <td height=30 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#888;">
        ...
        <img src="<?=$board_skin_path?>/img/icon_view.gif" align=absmiddle> Hit : <?=number_format($view[wr_hit])?>
