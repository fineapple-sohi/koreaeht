...
<tr height=34 align=center>
    ...
    <?/**/?><td width=40><?=subject_sort_link('wr_datetime', $qstr2, 1)?>DATE</a></td>
    <td width=50><?=subject_sort_link('wr_hit', $qstr2, 1)?>HIT</a></td><?/**/?>
    <!--<td width=40>날짜</td>
    <td width=50>조회</td>-->
    <?/*?><td width=40 title='마지막 코멘트 쓴 시간'><?=subject_sort_link('wr_last', $qstr2, 1)?>LATEST</a></td><?*/?>
    <? if ($is_good) { ?><td width=40><?=subject_sort_link('wr_good', $qstr2, 1)?>GOOD</a></td><?}?>
    <? if ($is_nogood) { ?><td width=40><?=subject_sort_link('wr_nogood', $qstr2, 1)?>NO GOOD</a></td><?}?>
</tr>
</table>
</div>
...
<tr height=29 align=center> 
    ...
    <td width=110><nobr style='display:block; overflow:hidden; width:105px;'><?=$list[$i][name]?></nobr></td>
...
<?}?>
<? if (count($list) == 0) { echo "<tr><td colspan='$colspan' height=100 align=center>EMPTY DATA</td></tr>"; } ?>
</table>
</form>
