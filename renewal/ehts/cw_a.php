    ...
    <tr>
        <td background=./images/box_02.gif style="background-repeat:repeat-y;">
            ...
            <tr>
				...
				<? include "../include/left_menu_bap2.php"; ?>
                </td>
                ...
                <td valign=top>
                    ...
                    <tr>
                        <td background=./images/st_bg.gif style="background-repeat:no-repeat;" width=688 height=100>
                            ...
                            <tr>
                                <td class=sst><img src=./images/sst/sst02_01_05.gif></td>
                            </tr>
                            </table>
                        </td>
                    <tr>
                        <td class=c>
                        <!-- content -->
						<br><img src="sub_img/Constant Wattage Heating Cable_Page_1.jpg" /><br><img src="sub_img/Constant Wattage Heating Cable_Page_2.jpg" />
                        <!-- content -->
                        </td>
                    </tr>
                    </table>
